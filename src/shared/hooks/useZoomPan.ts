 ...
 * same feel without a second copy of the maths, and moved to shared/ when the
 * media-only viewer (MediaLightbox) needed the same gestures — the post viewer
 * still imports it from features/posts/hooks, which re-exports this file.
 * What changed on the way out of MediaCarousel:
 *
